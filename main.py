...
driver.find_elements(By.XPATH,"//i[@class='oxd-icon bi-caret-down-fill oxd-select-text--arrow']")[1].click()
time.sleep(1)

driver.find_element(By.XPATH,"//div[@class='oxd-select-option']/child::span[text()='End Day Only']").click()
driver.find_elements(By.XPATH,"//i[@class='oxd-icon bi-caret-down-fill oxd-select-text--arrow']")[2].click()
time.sleep(1)
